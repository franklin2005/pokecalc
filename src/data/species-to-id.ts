...
const SPECIES_TO_ID: Record<string, number> = {
  ...
  Bronzong: 437, Bonsly: 438, Mime: 439, Happiny: 440, Chatot: 441,
  ...
  Type: 772, Silvally: 773, Minior: 774, Komala: 775, Turtonator: 776,
  ...
  Greedent: 820, Rookidee: 821, Corvisquire: 822, Corviknight: 823, Blipbug: 824,
  ...
  Sirfetchd: 865, 'Mr-Rime': 866, Runerigus: 867, Milcery: 868, Alcremie: 869,
  Falinks: 870, Pincurchin: 871, Snom: 872, Frosmoth: 873, Stonjourner: 874,
  Eiscue: 875, Indeedee: 876, Morpeko: 877, Cufant: 878, Copperajah: 879,
  Dracozolt: 880, Arctozolt: 881, Dracovish: 882, Arctovish: 883, Duraludon: 884,
  Dreepy: 885, Drakloak: 886, Dragapult: 887, Zacian: 888, Zamazenta: 889,
  ...
  Skeledirge: 911, Quaxly: 912, Quaxwell: 913, Quaquaval: 914, Lechonk: 915,
  Oinkologne: 916, Tarountula: 917, Spidops: 918, Nymble: 919, Lokix: 920,
  Pawmi: 921, Pawmo: 922, Pawmot: 923, Tandemaus: 924, Maushold: 925,
  Fidough: 926, Dachsbun: 927, Smoliv: 928, Dolliv: 929, Arboliva: 930,
  Squawkabilly: 931, Nacli: 932, Naclstack: 933, Garganacl: 934, Charcadet: 935,
  ...
  Bramblin: 946, Brambleghast: 947, Toedscool: 948, Toedscruel: 949, Klawf: 950,
  Capsakid: 951, Scovillain: 952, Rellor: 953, Rabsca: 954, Flittle: 955,
  Espathra: 956, Tinkatink: 957, Tinkatuff: 958, Tinkaton: 959, Wiglett: 960,
  Wugtrio: 961, Bombirdier: 962, Finizen: 963, Palafin: 964, Varoom: 965,
  Revavroom: 966, Cyclizar: 967, Orthworm: 968, Glimmet: 969, Glimmora: 970,
  Greavard: 971, Houndstone: 972, Flamigo: 973, Cetoddle: 974, Cetitan: 975,
  Veluza: 976, Dondozo: 977, Tatsugiri: 978, Annihilape: 979, Clodsire: 980,
  Farigiraf: 981, Dudunsparce: 982, Kingambit: 983, 'Great-Tusk': 984, 'Scream-Tail': 985,
  ...
  Dipplin: 1011, Poltchageist: 1012, Sinistcha: 1013, Okidogi: 1014, Munkidori: 1015,
...
export function getSpeciesId(speciesName: string): number | null {
  ...
  // Strip forme suffix: "Charizard-Mega-X" → "Charizard"
  // "Pikachu-Gmax" → "Pikachu"
  // "Meowstic-Male" → "Meowstic"
  const baseName = speciesName.split('-')[0]
  if (baseName in SPECIES_TO_ID) {
    return SPECIES_TO_ID[baseName]
  }

  // Handle special cases where the base name differs
  ...
  if (speciesName in specialCases) {
    const mapped = specialCases[speciesName]
    return SPECIES_TO_ID[mapped] ?? null
  }
